...
const I18N = {
  zh: {
    ...
    download: '下载打码结果',
    download_all: '下载全部打码结果',
    download_all_none: '还没有可下载的打码结果，先上传并处理图片吧',
    download_all_done: '已全部保存到相册 Pictures/NSFW Mask，共 {n} 张',
    download_all_partial: '保存完成：成功 {ok} 张，失败 {fail} 张',
    download_all_started: '已开始下载 {n} 张打码结果',
    start_over: '清空重来',
  ...
  en: {
    ...
    download_all: 'Download all censored images',
    download_all_none: 'No censored results yet — upload and process images first',
    download_all_done: 'All {n} image(s) saved to Pictures/NSFW Mask',
    download_all_partial: 'Saved: {ok} OK, {fail} failed',
    download_all_started: 'Downloading {n} censored image(s)',
  ...
  ja: {
    ...
    download_all: 'すべてのマスキング結果をダウンロード',
    download_all_none: 'ダウンロードできる結果がありません。先に画像を処理してください',
    download_all_done: '{n}枚すべてをアルバム Pictures/NSFW Mask に保存しました',
    download_all_partial: '保存完了：成功 {ok} 枚、失敗 {fail} 枚',
    download_all_started: '{n}枚のダウンロードを開始しました',
    start_over: 'クリア',
